      ...
      <table class="table data-list-view">
        ...
        <tbody>
          ...
          @endphp
            ...
            <tr>
              <td></td>
              <td class="product-name"><span><img class="round" src="{{ asset('storage/images/avatar/'.$user['avatar']) }}" height="40" width="40" /></span> &nbsp;&nbsp;{{$user["name"] }} </td>
              <td class="product-category">{{ $user["email"] }}</td>
              <td class="product-category">{{ $user["phone"] }}</td>
              <td>
                <div class="chip chip-{{$color}}">
                  <div class="chip-body">
                    <div class="chip-text">{{ $user["userType"]['name']}}</div>
                  </div>
                </div>
              </td>
            ...
            <div class="data-fields px-2 mt-1">
              <div class="row">
                ...
                <div class="col-sm-12 data-field-col">
                  ...
                  <select class="form-control" name="userTypeId" id="data-category" >
