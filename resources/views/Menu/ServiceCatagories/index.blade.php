...
<section id="data-list-view" class="data-list-view-header">
    ...
    <div class="table-responsive">
      <table class="table data-list-view">
        ...
        <tbody>
          @foreach ($serviceCatagories as $item)
            <tr>
              <td></td>
              ...
              <td class="product-action">
                ...
                <form action="{{ route('serviceCatagories.destroy', $item->id) }}" method="post">
                  @csrf
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <?php if (isset($item->getSelectedLogo()['fileName'])): ?>
                          <img src="{{url(config('global.picturePaths.serviceCatagories').$item->getSelectedLogo()['fileName'])}}" id="logoPreview" class="img-thumbnail" alt="Cinque Terre" style="width:100%">
                        <?php endif; ?>
                      </div>
                    </div>
                  </div>
    ...
    <div class="add-new-data-sidebar">
      ...
      <div class="add-new-data">
        <form method="post" action="{{ route('serviceCatagories.store') }}" enctype="multipart/form-data">
          @csrf
