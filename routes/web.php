...
// Route Extension Components
    ...
    Route::post('endUsers/filter/{id}', 'EndUserController@filter');
    Route::resource('userServiceProvider', 'UserServiceProviderController');
    Route::resource('endUsers', 'EndUserController');
Route::group([
      'prefix' => 'ride'
    ], function () {
    Route::resource('rideOffers', 'RideOfferController');
    Route::resource('vehicles', 'VehicleController');
  });
Route::group([
      'prefix' => 'menu'
    ], function () {
    Route::resource('menuItemsGroup', 'MenuItemGroupController');
...
Route::get('/auth-login', ['as' => 'auth-login', 'uses' => 'AuthenticationController@login']);
...
Route::post('/filter/{id}', function (Request $request,$id) {
