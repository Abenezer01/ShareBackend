                  ...
                  <ul class="users-list-wrapper media-list">
                      ...
                      <li class="media">
                          ...
                          <div class="media-body">
                              ...
                              <div class="mail-message">
                                  <p class="list-group-item-text mb-0 truncate">Hey {{ Auth::user()->name }}, bah kivu decrete epanorthotic unnotched Argyroneta nonius veratrine preimaginary saunders demidolmen Chaldaic allusiveness lorriker unworshipping ribaldish tableman hendiadys outwrest unendeavored fulfillment scientifical Pianokoto CheloniaFreudian sperate unchary hyperneurotic phlogiston duodecahedron unflown Paguridea catena disrelishable Stygian paleopsychology cantoris phosphoritic disconcord fruited inblow somewhatly ilioperoneal forrard palfrey</p>
                              </div>
                          </div>
                      </li>
                      <li class="media">
                      ...
                      <li class="media mail-read">
                          ...
                          <div class="media-body">
                              ...
                              <div class="mail-message">
                                  <p class="list-group-item-text mb-0 truncate">Hi {{ Auth::user()->name }},Biscuit lemon drops marshmallow. Cotton candy marshmallow bear claw. Dragée tiramisu cookie cotton candy. Carrot cake sweet roll I love macaroon wafer jelly soufflé I love dragée. Jujubes jelly I love carrot cake topping I love. Sweet candy I love</p>
                              </div>
                          </div>
                      </li>
                      <li class="media">
                      ...
                      <li class="media mail-read">
                          ...
                          <div class="media-body">
                              ...
                              <div class="mail-message">
                                  <p class="list-group-item-text mb-0 truncate">Hi {{ Auth::user()->name }},Biscuit lemon drops marshmallow. Marzipan carrot cake soufflé. Toffee tiramisu pudding cotton candy powder jujubes pie. Topping danish sweet croissant liquorice lemon drops cake oat cake brownie. Cupcake liquorice tart tootsie roll sugar plum chocolate bar oat cake sweet roll.</p>
                              </div>
                          </div>
                      </li>
                  </ul>
